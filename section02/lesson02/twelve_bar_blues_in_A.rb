...
in_thread(name: :right_hand) do
  2.times do
    straight_eight_boogie_treble(:A4)
  end
  straight_eight_boogie_treble(:D5)
  straight_eight_boogie_treble(:A4)
  straight_eight_boogie_treble(:E5, regression: false)
  straight_eight_boogie_treble(:D5, regression: false)
  straight_eight_boogie_treble(:A4)
end
